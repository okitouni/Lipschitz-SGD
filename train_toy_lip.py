...
import torch
from models import Unconstrained
...
Y = torch.sin(X * 2 * torch.pi).view(-1, 1)
...
def train(model=model, verbose=True):
    metrics = {}
    ...
    if PLOT:
        ...
        for i in range(N_MODELS):
            ...
            for epoch in pbar:
                ...
                torch.save(model_copy.state_dict(), f'models/model{i}-{epoch}.pt')
